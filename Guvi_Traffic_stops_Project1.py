...
user_query = "select * from stop_details"
...
query_map = {
    "Total Number of Police Stops": "SELECT COUNT(*) AS stop_details FROM stop_details",
    ...
    "Average age of Drivers stopped": "SELECT floor(AVG(driver_age)) AS average_age FROM stop_details",
...
if category_query_list:
    ...
    result_output = pd.DataFrame(result_info)
